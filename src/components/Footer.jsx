    ...
    <footer className=" flex justify-center  bg-blue-400 leading-loose text-slate-600">
      <div className="">
        <div className=" p-10 text-center">
          ...
          <div className="">
            <p>
              Welcome to my frontend portfolio! I'm a dedicated frontend
              developer with a passion for crafting immersive and user-friendly
              web experiences. Through a blend of design and technical
              expertise, I transform concepts into visually stunning and
              seamlessly functional websites. Explore my projects of frontend
